# Generated by Django 3.1.7 on 2021-03-25 03:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Role',
            fields=[
                ('id', models.PositiveSmallIntegerField(choices=[(1, 'Admin'), (2, 'Gerente'), (3, 'Cajero')], primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_img', models.ImageField(blank=True, help_text='An image of the user', null=True, upload_to='profile_img', verbose_name='Profile Image')),
                ...
                ('roles', models.ManyToManyField(null=True, related_name='profiles', to='Users.Role')),
            ],
            options={
